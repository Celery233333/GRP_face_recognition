...
def _inception_resnet_block(x, scale, block_type, block_idx, activation='relu'):
    ...
    # structure of inception-resnet-A
    ...
    # structure of inception-resnet-B
    ...
    # structure of inception-resnet-C
...
def InceptionResNetV1(input_shape=(160, 160, 3),
    ...
    # 160,160,3 -> 77,77,64 （'valid' will drop some pixels)
